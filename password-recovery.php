...
if (isset($_POST['send'])) {
    ...
    $stmt = $pdo->prepare("SELECT email, password, fname FROM users WHERE email = :email");
    $stmt->execute(['email' => $femail]);
    ...
    if ($row) {
        ...
        $mail->setFrom('your-email@gmail.com', 'Your Name');  // Set your email address and name
