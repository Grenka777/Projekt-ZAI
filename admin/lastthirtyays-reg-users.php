                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php 
                                    $stmt = $pdo->query("SELECT * FROM users WHERE DATE(posting_date) >= CURDATE() - INTERVAL 30 DAY");
                                    $cnt = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="lastthirtyays-reg-users.php?id=<?php echo $row['id']; ?>" onClick="return confirm('Do you really want to delete');">
