        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <h3>Search Results against keyword '<?php echo htmlspecialchars($_POST['searchkey']); ?>'</h3>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $stmt = $pdo->prepare("SELECT * FROM users WHERE fname LIKE :searchkey OR email LIKE :searchkey OR contactno LIKE :searchkey");
